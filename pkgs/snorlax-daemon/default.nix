...
# at native/linux from the snorlax flake input and produces four binaries:
...
# All four land in $out/bin as siblings, so svcctl's current_exe()-relative lookup of
