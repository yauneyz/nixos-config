...
model="${1:-${LLAMA_CYDONIA_24B_MODEL:-$models_dir/TheDrummer_Cydonia-24B-v4.3-Q6_K.gguf}}"
if [[ ! -f "$model" ]]; then
  echo "Model file not found: $model" >&2
  echo "Expected Cydonia v4.3 Q6_K GGUF at $models_dir/TheDrummer_Cydonia-24B-v4.3-Q6_K.gguf" >&2
  echo "Download it with: roleplay-models-download" >&2
  exit 1
fi
...
alias_name="${LLAMA_ALIAS:-cydonia-24b}"
